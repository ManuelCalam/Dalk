...
class _PetUpdateProfileWidgetState extends State<PetUpdateProfileWidget> {
  ...
  AutovalidateMode _raceValidateMode = AutovalidateMode.disabled;
                                        ...
                                        child: Padding(
                                          ...
                                          child: Container(
                                            ...
                                            child: TextFormField(
                                              ...
                                              obscureText: false,
                                              onChanged: (value) {
                                                if (_raceValidateMode == AutovalidateMode.disabled) {
                                                  setState(() {
                                                    _raceValidateMode = AutovalidateMode.always;
                                                  });
                                                }
                                              },
                                              decoration: InputDecoration(
                                              ...
                                              autovalidateMode: _raceValidateMode,
                                            ),
                                          ),
                                        ),
                                      ),
                                            ...
                                            child: TextFormField(
                                              ...
                                              decoration: InputDecoration(
                                                ...
                                                fillColor:
                                                    FlutterFlowTheme.of(context)
                                                        .alternate,
                                                contentPadding: const EdgeInsetsDirectional.fromSTEB(10, 15, 10, 15),
                                                prefixIcon: Icon(
                                                  Icons.person,
                                                  color:
                                                      FlutterFlowTheme.of(context)
