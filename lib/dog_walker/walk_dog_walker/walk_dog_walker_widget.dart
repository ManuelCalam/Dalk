...
import 'walk_dog_walker_model.dart';
export 'walk_dog_walker_model.dart';

class WalkDogWalkerWidget extends StatefulWidget {
  const WalkDogWalkerWidget({super.key});

  static String routeName = 'walk_dogWalker';
  static String routePath = '/walkDogWalker';

  @override
  State<WalkDogWalkerWidget> createState() => _WalkDogWalkerWidgetState();
}

class _WalkDogWalkerWidgetState extends State<WalkDogWalkerWidget>
    with TickerProviderStateMixin {
  late WalkDogWalkerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WalkDogWalkerModel());
