...
import 'accepted_walk_walker_card_model.dart';
export 'accepted_walk_walker_card_model.dart';

class AcceptedWalkWalkerCardWidget extends StatefulWidget {
  const AcceptedWalkWalkerCardWidget({
    super.key,
    required this.id,
    String? petName,
    String? dogOwner,
  ...
  @override
  State<AcceptedWalkWalkerCardWidget> createState() =>
      _AcceptedWalkWalkerCardWidgetState();
}

class _AcceptedWalkWalkerCardWidgetState
    extends State<AcceptedWalkWalkerCardWidget> {
  late AcceptedWalkWalkerCardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AcceptedWalkWalkerCardModel());
  }
