...
import 'non_reviewed_walk_card_model.dart';
export 'non_reviewed_walk_card_model.dart';
...
class NonReviewedWalkCardWidget extends StatefulWidget {
  ...
  @override
  State<NonReviewedWalkCardWidget> createState() =>
      _NonReviewedWalkCardWidgetState();
}

class _NonReviewedWalkCardWidgetState extends State<NonReviewedWalkCardWidget> {
  late NonReviewedWalkCardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NonReviewedWalkCardModel());
  }
